...
void HistogramAssignment(Mat& image)
{
	...
	Mat output2 = JoinImagesHorizontally(image, "Colour image", colour_display_image, "RGB Histograms", 4);
	imshow("Histograms", output2);
